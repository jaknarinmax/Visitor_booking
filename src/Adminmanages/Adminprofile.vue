<template>
            ...
            <div class="mx-auto overflow-hidden rounded-lg bg-white shadow-2xl sm:w-full sm:max-w-lg">
                <div class="relative p-6">
                    <div class="flex gap-4">
                        <div class="flex h-12 w-12 items-center justify-center rounded-full bg-green-100 text-green-500 shadow-lg"
                        ...
                        <div class="flex-1">
                            <h3 class="text-lg font-medium text-secondary-900">Edit completed successfully</h3>
                            <div class="mt-2 text-sm text-secondary-500">Your changes have been saved and applied successfully.
                            </div>
                        </div>
                    </div>
                    <div class="mt-6 flex justify-end gap-3">
                        <button @click="confirmEdit" class=" bg-sky-200   rounded-lg bg-primary-500 px-4 py-2 text-center text-sm font-medium text-black shadow-2xl transition-all hover:bg-primary-700 focus:ring focus:ring-primary-200 disabled:cursor-not-allowed disabled:bg-primary-300">
                            Confirm
                    </button>
                    </div>
                </div>
    ...
    <div v-if="showmodalapprovalpending">
        ...
        <div x-cloak x-show="showModal" x-transition
            ...
            <div class="mx-auto overflow-hidden rounded-lg bg-white shadow-2xl sm:w-full sm:max-w-lg">
                <div class="relative p-6">
                    <div class="flex gap-4">
                        <div class="flex h-12 w-12 items-center justify-center rounded-full bg-yellow-100 text-yellow-500 shadow-lg"
                            style="box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.3), 0 4px 6px -2px rgba(0, 0, 0, 0.2);">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="h-6 w-6">
                    ...
                    <div class="mt-6 flex justify-end gap-3">
                        <button type="button" @click="showmodalapprovalpending = false"
                            class=" bg-red-200 rounded-lg bg-primary-500 px-4 py-2 text-center text-sm font-medium text-black shadow-2xl transition-all hover:bg-primary-700 focus:ring focus:ring-primary-200 disabled:cursor-not-allowed disabled:bg-primary-300">
                            OK
                        </button>
                    </div>
                </div>
    ...
    <TransitionChild v-if="showModalexpire" as="template" enter="ease-out duration-300" enter-from="opacity-0"
