      ...
      <div class="flex flex-col flex-1 overflow-hidden">
        ...
        <div class="flex-1 overflow-y-auto p-4" @click="closetoggleSidebar">
          ...
          <div class="flex flex-row  mt-2 justify-center" >
            <div class="bg-no-repeat bg-red-200 border border-red-300 rounded-xl flex-1 mx-2 p-2"
            ...
            <p class="text-2xl text-indigo-900">Wait for approval<br><strong>{{ totalEntries1 }}</strong> </p>
            <br>
            ...
            <div class="bg-no-repeat bg-blue-200 border border-blue-300 rounded-xl flex-1 mx-2 p-2"
                ...
                <p class="text-2xl text-indigo-900">Approved tickets<br><strong>{{ totalEntriessucceed }}</strong></p>
                <br>
            ...
            <div class="bg-no-repeat bg-purple-200 border border-orange-300 rounded-xl flex-1 mx-2 p-2"
            style="background-image: url(https://previews.dropbox.com/p/thumb/AAuwpqWfUgs9aC5lRoM_f-yi7OPV4txbpW1makBEj5l21sDbEGYsrC9sb6bwUFXTSsekeka5xb7_IHCdyM4p9XCUaoUjpaTSlKK99S_k4L5PIspjqKkiWoaUYiAeQIdnaUvZJlgAGVUEJoy-1PA9i6Jj0GHQTrF_h9MVEnCyPQ-kg4_p7kZ8Yk0TMTL7XDx4jGJFkz75geOdOklKT3GqY9U9JtxxvRRyo1Un8hOObbWQBS1eYE-MowAI5rNqHCE_e-44yXKY6AKJocLPXz_U4xp87K4mVGehFKC6dgk_i5Ur7gspuD7gRBDvd0sanJ9Ybr_6s2hZhrpad-2WFwWqSNkh/p.png?fv_content=true&size_mode=5); background-position: 100% 40%;">
            <p class="text-2xl text-indigo-900">Cancelled tickets<br><strong>54</strong></p>
                <br>
            <button  class="group relative inline-block px-8 py-2 font-medium">
                    <span class="absolute inset-0 h-full w-full translate-x-1 translate-y-1 transform border-2 border-dotted border-blue-200 bg-black transition duration-200 ease-out group-hover:-translate-x-1 group-hover:-translate-y-1 group-hover:bg-white"></span>
                    <span class="absolute inset-0 h-full w-full border-2 border-dotted border-red-600 bg-white group-hover:bg-red-600"></span>
                    <span class="relative text-black group-hover:text-white">TICKET</span>
            </button>
            ...
            <div class="bg-red-200" v-for="booking in bookings" :key="booking._id" style="flex-basis: calc(33.333% - 30px); margin-top: 15px; border-radius: 20px; padding: 40px;">
                    ...
                    <div class="inline-block min-w-full shadow rounded-lg overflow-hidden">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="px-2 py-3 border-b border-gray-600 bg-white text-sm">
                                <p class="text-gray-900 whitespace-no-wrap">
                                    {{ booking.userId[0].firstname }} {{ booking.userId[0].lastname }}
                                </p>
                                </td>
                            ...
                            <table class="min-w-full leading-normal">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="bg-blue-300 px-1 py-3 border-b-2 border-gray-200 text-center text-xs font-semibold text-gray-800 uppercase tracking-wider" style="width: 15%;">VIEWPARTICIPANT/<br>DELETEBOOKING/<br>GIVE TICKETS</th>
                                    </tr>
                                </thead>
                                <tbody>
...
import AdminSalesTopNav from './AdminTopNav.vue';
    ...
    async fetchBookingssucceed() {
        try {
        const response = await axios.get('http://LOCALHOST:9992/bookingsuccess/ticketsuccessall');
    ...
    const bookingUser = this.bookingssucceed.find(booking => booking.userId && booking.userId._id === userId);
    
    if (bookingUser && bookingUser.userId) {
        return `${bookingUser.userId.firstname || ''} ${bookingUser.userId.lastname || ''}`.trim() || 'Unknown User';
    }
