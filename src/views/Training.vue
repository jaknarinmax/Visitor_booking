<template>
  ...
  <div
    ...
    <div class="para uppercase text-center leading-none z-40">
      <p style="-webkit-text-stroke: 1px rgb(207, 205, 205);
      ...
      <div
        ...
        <ul class="flex flex-col items-start gap-2">
          <li
            ...
            <svg stroke-linejoin="round" stroke-linecap="round" stroke-width="3" class="stroke-[#495c48]"
              stroke="#000000" fill="none" viewBox="0 0 24 24" height="10" width="10"
