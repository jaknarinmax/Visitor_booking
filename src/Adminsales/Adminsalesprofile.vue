                ...
                <div class="relative p-6">
                    ...
                    <div class="mt-6 flex justify-end gap-3">
                        <button @click="confirmEdit"
                            class=" bg-sky-200   rounded-lg bg-primary-500 px-4 py-2 text-center text-sm font-medium text-black shadow-2xl transition-all hover:bg-primary-700 focus:ring focus:ring-primary-200 disabled:cursor-not-allowed disabled:bg-primary-300">Confirm
                        </button>
                    </div>
                </div>
            </div>
